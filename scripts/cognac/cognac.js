...
var lib_engine_templateObject, engine_templateObject2;
...
var engine_Engine = /*#__PURE__*/function (_BaseEngine) {
  ...
  lib_engine_createClass(Engine, [{
    ...
    value: function execute(task) {
      ...
      if (property_get("lastEncounter") !== "Poetic Justice" && (0,external_kolmafia_namespaceObject.haveEffect)($effect(lib_engine_templateObject || (lib_engine_templateObject = lib_engine_taggedTemplateLiteral(["Beaten Up"]))))) {
        throw "Combat lost";
      }
      uneffect($effect(engine_templateObject2 || (engine_templateObject2 = lib_engine_taggedTemplateLiteral(["Beaten Up"]))));
    }
  }]);
  return Engine;
}(Engine);
...
var effects_templateObject, effects_templateObject2, effects_templateObject3, effects_templateObject4, effects_templateObject5, effects_templateObject6, effects_templateObject7, effects_templateObject8, effects_templateObject9, effects_templateObject10;
...
function basicEffects() {
  var effects = [];
  if (have(template_string_$skill(effects_templateObject || (effects_templateObject = effects_taggedTemplateLiteral(["The Sonata of Sneakiness"]))))) {
    effects.push($effect(effects_templateObject2 || (effects_templateObject2 = effects_taggedTemplateLiteral(["The Sonata of Sneakiness"]))));
  }
  if (have(template_string_$skill(effects_templateObject3 || (effects_templateObject3 = effects_taggedTemplateLiteral(["Smooth Movement"]))))) {
    effects.push($effect(effects_templateObject4 || (effects_templateObject4 = effects_taggedTemplateLiteral(["Smooth Movements"]))));
  }
  if (have(template_string_$skill(effects_templateObject5 || (effects_templateObject5 = effects_taggedTemplateLiteral(["Leash of Linguini"]))))) {
    effects.push($effect(effects_templateObject6 || (effects_templateObject6 = effects_taggedTemplateLiteral(["Leash of Linguini"]))));
  }
  if (have(template_string_$skill(effects_templateObject7 || (effects_templateObject7 = effects_taggedTemplateLiteral(["Empathy of the Newt"]))))) {
    effects.push($effect(effects_templateObject8 || (effects_templateObject8 = effects_taggedTemplateLiteral(["Empathy"]))));
  }
  if (have(template_string_$skill(effects_templateObject9 || (effects_templateObject9 = effects_taggedTemplateLiteral(["Blood Bond"]))))) {
    effects.push($effect(effects_templateObject10 || (effects_templateObject10 = effects_taggedTemplateLiteral(["Blood Bond"]))));
  }
  return effects;
}
...
;// CONCATENATED MODULE: ./src/tasks/cognac/heap.ts
var heap_templateObject, heap_templateObject2, heap_templateObject3, heap_templateObject4, heap_templateObject5, heap_templateObject6;
  ...
  heap_createClass(Heap, [{
    ...
    value: function getTasks() {
      return [{
        ...
        outfit: {
          equip: getEquipment([template_string_$item(heap_templateObject4 || (heap_templateObject4 = heap_taggedTemplateLiteral(["June cleaver"]))), template_string_$item(heap_templateObject5 || (heap_templateObject5 = heap_taggedTemplateLiteral(["Greatest American Pants"])))].filter(have)),
          modifier: "-combat",
          familiar: template_string_$familiar(heap_templateObject6 || (heap_templateObject6 = heap_taggedTemplateLiteral(["Disgeist"])))
        },
        choices: {
          203: 2,
          214: 2,
...
;// CONCATENATED MODULE: ./src/tasks/cognac/pld.ts
var pld_templateObject, pld_templateObject2, pld_templateObject3, pld_templateObject4, pld_templateObject5, pld_templateObject6;
  ...
  pld_createClass(PLD, [{
    ...
    value: function getTasks() {
      return [{
        ...
        effects: basicEffects(),
        combat: new CombatStrategy().macro(getCombat(pld_runaway)),
        outfit: {
          equip: getEquipment([template_string_$item(pld_templateObject4 || (pld_templateObject4 = pld_taggedTemplateLiteral(["June cleaver"]))), template_string_$item(pld_templateObject5 || (pld_templateObject5 = pld_taggedTemplateLiteral(["Greatest American Pants"])))]),
          modifier: "-combat",
          familiar: template_string_$familiar(pld_templateObject6 || (pld_templateObject6 = pld_taggedTemplateLiteral(["Disgeist"])))
        },
        choices: {
          205: 2,
          219: 2,
...
;// CONCATENATED MODULE: ./src/tasks/cognac/whiteboard.ts
...
;// CONCATENATED MODULE: ./src/tasks/cognac/round.ts
...
;// CONCATENATED MODULE: ./src/tasks/cognac/cognac.ts
...
;// CONCATENATED MODULE: ./src/tasks/prologue/prologue.ts
var prologue_templateObject, prologue_templateObject2;
...
var Prologue = {
  ...
  tasks: [{
    ...
    do: () => {
      asdonInstalled = true;
      if (installed() || !have(template_string_$item(prologue_templateObject || (prologue_templateObject = prologue_taggedTemplateLiteral(["Asdon Martin keyfob"]))))) {
        return;
      }
      if (!property_get(ASDON)) {
        return;
      }
      (0,external_kolmafia_namespaceObject.use)(template_string_$item(prologue_templateObject2 || (prologue_templateObject2 = prologue_taggedTemplateLiteral(["Asdon Martin keyfob"]))));
    }
  }]
};
;// CONCATENATED MODULE: ./src/tasks/sewers/acquire.ts
...
;// CONCATENATED MODULE: ./src/tasks/sewers/cage.ts
...
;// CONCATENATED MODULE: ./src/tasks/sewers/explore.ts
var explore_templateObject, explore_templateObject2, explore_templateObject3, explore_templateObject4, explore_templateObject5, explore_templateObject6;
...
var ExploreTasks = [{
  ...
  outfit: {
    equip: [template_string_$item(explore_templateObject4 || (explore_templateObject4 = explore_taggedTemplateLiteral(["gatorskin umbrella"]))), template_string_$item(explore_templateObject5 || (explore_templateObject5 = explore_taggedTemplateLiteral(["hobo code binder"])))],
    modifier: "-combat",
    familiar: template_string_$familiar(explore_templateObject6 || (explore_templateObject6 = explore_taggedTemplateLiteral(["Disgeist"])))
  },
  choices: {
    197: 1,
    198: 1,
...
;// CONCATENATED MODULE: ./src/tasks/sewers/sewers.ts
...
var Sewers = {
  ...
  tasks: [].concat(sewers_toConsumableArray(globalTasks()), sewers_toConsumableArray(CageTasks), sewers_toConsumableArray(AcquireTasks), sewers_toConsumableArray(ExploreTasks))
};
;// CONCATENATED MODULE: ./src/tasks/townsquare/combat.ts
...
;// CONCATENATED MODULE: ./src/tasks/townsquare/explore.ts
var townsquare_explore_templateObject, townsquare_explore_templateObject2, townsquare_explore_templateObject3, townsquare_explore_templateObject4, townsquare_explore_templateObject5, townsquare_explore_templateObject6, explore_templateObject7, explore_templateObject8;
...
function townsquare_explore_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }



var elementMap = {
  hot: $effects(townsquare_explore_templateObject || (townsquare_explore_templateObject = townsquare_explore_taggedTemplateLiteral(["Spirit of Cayenne"]))),
  cold: $effects(townsquare_explore_templateObject2 || (townsquare_explore_templateObject2 = townsquare_explore_taggedTemplateLiteral(["Spirit of Peppermint"]))),
  stench: $effects(townsquare_explore_templateObject3 || (townsquare_explore_templateObject3 = townsquare_explore_taggedTemplateLiteral(["Spirit of Garlic"]))),
  spooky: $effects(townsquare_explore_templateObject4 || (townsquare_explore_templateObject4 = townsquare_explore_taggedTemplateLiteral(["Spirit of Wormwood"]))),
  sleaze: $effects(townsquare_explore_templateObject5 || (townsquare_explore_templateObject5 = townsquare_explore_taggedTemplateLiteral(["Spirit of Bacon Grease"]))),
  normal: []
};
  ...
  function Explore(parts) {
    ...
    explore_defineProperty(this, "baseTask", {
      do: () => {
        ...
        return $location(townsquare_explore_templateObject6 || (townsquare_explore_templateObject6 = townsquare_explore_taggedTemplateLiteral(["Hobopolis Town Square"])));
      },
  ...
  explore_createClass(Explore, [{
    ...
    value: function getTasks() {
      return [{
        ...
        effects: [$effect(explore_templateObject7 || (explore_templateObject7 = townsquare_explore_taggedTemplateLiteral(["Carol of the Bulls"])))],
        outfit: {
          equip: [template_string_$item(explore_templateObject8 || (explore_templateObject8 = townsquare_explore_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))]
        }
      }), explore_objectSpread(explore_objectSpread({}, this.baseTask), {}, {
...
;// CONCATENATED MODULE: ./src/tasks/townsquare/scobo.ts
...
;// CONCATENATED MODULE: ./src/tasks/townsquare/townsquare.ts
...
var TownSquare = {
  ...
  tasks: [].concat(townsquare_toConsumableArray(globalTasks()), townsquare_toConsumableArray(scobo.getTasks()), townsquare_toConsumableArray(explore.getTasks()))
};
...
function main(command) {
  ...
  checkGarbo();
  checkClan();
  var cognacTasks = getTasks([Prologue, Sewers, TownSquare, Cognac]);
